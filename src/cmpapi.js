    ...
    switch (command) {
      ...
      case 'setConsent':
        ...
        image.onload = function () {
          ...
          metaSetConsent.src = window.location.protocol + '//{{META_ENDPOINT}}?action=setConsent' + didParam(setConsentDid) + '&consent=' + encodeURIComponent(serializeConsentByVendorId(updated));
      ...
      case 'setConsentByVendorId':
        ...
        image.onload = function () {
          ...
          metaSetByVendor.src = window.location.protocol + '//{{META_ENDPOINT}}?action=setConsentByVendorId' + didParam(setByVendorDid) + '&consent=' + encodeURIComponent(serializeConsentByVendorId(merged));
