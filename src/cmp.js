...
(function () {
  ...
  function createIframe() {
    ...
    iframe.setAttribute('src', window.location.protocol + '//__ejs(/*-CONSENT_HOST*/);__ejs(/*-CONSENT_PATH*/);iframe.html');
  ...
  function createCmpApiScriptTag() {
    ...
    cmpapiScriptTag.setAttribute('src', window.location.protocol + '//__ejs(/*-CONSENT_HOST*/);__ejs(/*-CONSENT_PATH*/);cmpapi.js');
